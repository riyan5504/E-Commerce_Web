		...
		<div class="container">
			<div class="header-top-wrapper">
				<a href="{{url('/')}}" class="brand-logo-outer">
					<img src="{{asset('/frontend/images/logo-01.jpg')}}" alt="Logo">
				</a>
							...
							<div class="cart-items-outer">
								<div class="cart-item-outer">
									<a href="#" class="cart-product-image">
										<img src="/frontend/images/product.png" alt="product">
									</a>
						...
						<div class="header__category-items-wrapper">
							...
							<div class="header__category-items-outer">
								<ul class="header__category-list">
									@foreach ($genarelCategories as $category)
										<li class="header__category-list-item item-has-submenu">
										<a href="{{ url('/category/product/'.$category->slug.'/'.$category->id) }}" class="header__category-list-item-link">
										...
										<ul class="header__nav-item-category-submenu">
											@foreach ($category->subCategory as $subcategory)
												...
												<a href="{{ url('/sub-category/product/' . $subcategory->slug . '/' . $subcategory->id) }}" class="header__category-submenu-item-link">
													{{$subcategory->name}}
												</a>
											</li>
											@endforeach
